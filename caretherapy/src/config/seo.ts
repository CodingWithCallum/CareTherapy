...
export const SITE_CONFIG = {
  ...
  description: 'Expert exercise therapy and rehabilitation services in Johannesburg. Mobile physiotherapy, elderly mobility training, sports injury prevention, and personalized recovery programs.',
  locale: 'en_ZA',
  keywords: [
