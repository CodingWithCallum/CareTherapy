...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: `<p>Therapeutic exercise is more than just a temporary fix for injuries or discomfort. When approached systematically and consistently, it becomes a powerful tool for long-term health, performance enhancement, and injury prevention.</p>
...
<p>Ready to experience these benefits for yourself? Contact us today to schedule your initial assessment and start your journey toward better movement and lasting health.</p>`,
  ...
  },
  {
    ...
    content: `<p>Maintaining mobility and independence is crucial for quality of life as we age. These five essential tips can help seniors stay active, reduce fall risk, and continue enjoying their favorite activities.</p>
...
<p>Always consult with your healthcare provider before starting a new exercise program. At CARE Therapy, we specialize in creating safe, effective exercise programs for seniors that can be done in the comfort of your own home.</p>`,
  ...
  },
  {
    ...
    content: `<p>Sports injuries can sideline athletes for weeks or even months. However, many injuries are preventable with the right approach to training, preparation, and recovery.</p>
...
<p>At CARE Therapy, we help athletes optimize their training, prevent injuries, and perform at their best. Our sports performance programs are designed to give you a competitive edge while keeping you healthy.</p>`,
  ...
  },
  {
    ...
    content: `<p>A movement assessment is the foundation of effective therapeutic exercise. It provides valuable insights into how your body moves, identifies areas of dysfunction, and guides the creation of your personalized program.</p>
...
<p>Book your movement assessment today and take the first step toward better movement, reduced pain, and improved performance.</p>`,
  ...
  },
  {
    ...
    content: `<p>Recovering from an injury can be challenging, but understanding the rehabilitation process helps you stay motivated and achieve the best possible outcome.</p>
...
<p>At CARE Therapy, we guide you through every stage of rehabilitation with evidence-based treatment and compassionate support. Contact us to start your recovery journey.</p>`,
  ...
  },
  {
    ...
    content: `<p>You don't need a fully equipped gym to do effective therapeutic exercise at home. With a few key pieces of equipment, you can perform most exercises prescribed by your therapist.</p>

<h1>Must-Have Equipment</h1>
